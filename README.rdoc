=FootUp
==https://shrouded-forest-40818.herokuapp.com/
...
====Registration
http://i.imgur.com/jrW73JS.png
====Profile Setup
http://i.imgur.com/AkoMFU3.png
====Game Feed
http://i.imgur.com/SdgNIbU.png
====Create Game
http://i.imgur.com/ETTZJaP.png
====Create Game by Location
http://i.imgur.com/43D3siC.png
====Game Details
http://i.imgur.com/wAfdPpx.png
====Public Profile Pages
http://i.imgur.com/by8Nbpe.png
====Invitations
http://i.imgur.com/oGlrksR.png

==ERD Diagram / Model Associations
In this project I only had two models with a `has_and_belongs_to_many` or a many-to-many
relationship.
http://i.imgur.com/ZwDlsIy.png
